  ...
  return (
    <div className="relative w-full h-full min-h-[calc(100dvh-76px)] overflow-hidden">
      ...
      <motion.div
        ...
        animate={{ height: isExpanded ? "min(650px, 85dvh)" : "100px" }}
      ...
      >
          ...
          <div className="flex w-full items-center justify-between">
            <div className="flex flex-col min-w-0">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-sm">Request a ride</span>
              </div>
              {!isExpanded && (
        ...
        <div className="overflow-y-auto p-4 space-y-4 flex-1">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              id="notes"
              placeholder="Preferences, details, notes for the driver…"
